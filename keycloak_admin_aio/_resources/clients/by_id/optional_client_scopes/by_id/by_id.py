...
class ClientsByIdOptionalClientScopesById(KeycloakResourceWithIdentifier):
    ...
    async def create(self):
        ...
        .. code:: python
            ...
            await kc.clients.by_id(client_uuid).optional_client_scopes.by_id(client_scope_id).create()
        """
    ...
    async def delete(self):
        ...
        .. code:: python
            ...
            await kc.clients.by_id(client_uuid).optional_client_scopes.by_id(client_scope_id).delete()
        """
        connection = await self._get_connection()
